...
function library:Evil(text,logo)
	...
	Main:TweenSize(UDim2.new(0,555,0,400),"Out","Quad",0.4,true)
		...
		function(io, p)
			if io.KeyCode == UIConfig.Bind then
				if uitoggled == false then
					...
					UI.Enabled = true
					Main:TweenSize(UDim2.new(0, 555, 0, 400), Enum.EasingDirection.Out, Enum.EasingStyle.Quart,0.4,true)
					uitoggled = false
				end
			end
		end
